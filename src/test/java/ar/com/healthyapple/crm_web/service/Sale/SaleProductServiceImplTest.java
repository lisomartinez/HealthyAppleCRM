...
public class SaleProductServiceImplTest {
    ...
    public void setUp() {
        ...
        productService =  new ProductService("ServiceTest", "This is a productService test",  product, BigDecimal.valueOf(1000));
        saleRequest = new SaleBuilder()
                .setTag("serviceTest")
                .setDescription("This is a productService test")
                .setState(saleState)
                .setClient(client)
                .setOriginDate( LocalDate.of(2018, 3, 10))
                .setDueDate( LocalDate.of(2018, 9, 10))
                .setFinalPrice(BigDecimal.valueOf(5000))
                .setServiceList(Arrays.asList(productService))
                .build();
